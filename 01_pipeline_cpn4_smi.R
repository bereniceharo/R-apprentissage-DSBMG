# ============================================================
# Pipeline ENDOS-BF — Sessions 12.1 + 12.2 + 12.3
# Objectif: 
# Construire, sur ENDOS-BF production, le pipeline complet pour un indicateur, 
# sur les 48 CSPS publics, sur une période absolue récente, jusqu'à un data frame 
# propre avec les trous en NA visibles.
# ============================================================
...
cpn4_b <- "g4H2aGAHFg9"                                  #SMI-Couverture en CPN4
uids_cp1er <- "wE3W4dyVjzI"                              #SMI-Proportion de femmes vues au 1er trimestre pour la CPN1
