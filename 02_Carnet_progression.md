...
| 59 | `shapiro.test()` — tester la normalité : H0 = distribution normale ; p < 0.05 -> rejeter H0 ; W proche de 1 = proche de la normale ; limité à 5000 observations | 9.3 | 27/05/2026 | 28/05/2026 | 28/05/2026 | 03/06/2026 |  08/06/2026 | 26/06/2026 |  | J+7 le 08/06/2026 | Dû J+7 |
...
| 61 | `modify_header()` (gtsummary) — modifie l'en-tête d'une colonne ; cible le nom interne (`label` à gauche, `stat_0`/`stat_1`… pour les stats) ; gras via markdown `**texte**` ; n'agit que sur les titres, pas les données | 12.x reporting | 07/06/2026 | 08/06/2026 | 08/06/2026 | 14/06/2026 |  | 07/07/2026 |  | J+1 le 08/06/2026 | A jour |
...
| 63 | `save_as_docx()` (flextable) — écrit un objet flextable en fichier .docx ; effet de bord (retourne le chemin, pas un objet R) ; exige un flextable en entrée ; chemin relatif ancré sur getwd(), ou here() pour ancrage projet | 12.x reporting | 07/06/2026 | 08/06/2026 | 08/06/2026 | 14/06/2026 |  | 07/07/2026 |  | J+1 le 08/06/2026| A jour |
