...
Session 3.3 — Trois formats de sauvegarde : write.csv2() pour partager, write_xlsx() pour l'institutionnel, saveRDS() pour toi. Le CSV perd les types, le RDS conserve tout.
...
- **Date et durée**: 28 avril, 02h
- **Ce qui était prévu**  boucle for
- **Ce qui a été fait** structure de la boucle for
